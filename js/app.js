...
sr.reveal(".hero-banner", { origin: "top", delay: 700 });
...
sr.reveal(`.sub-heading `, { distance: "300px", origin: "right", delay: 100 });
...
sr.reveal(`.links`, { distance: "300px", origin: "left", delay: 800 });
sr.reveal(`.my_social`, {
  distance: "300px",
  interval: 200,
  origin: "left",
...
sr.reveal(`.filter-btn`, { distance: "200px", interval: 100, origin: "top" });

sr.reveal(`.prt-card`, { origin: "top", interval: 400, delay: 400 });

sr.reveal(`.contact-form`, { origin: "right", distance: "200px", delay: 400 });
